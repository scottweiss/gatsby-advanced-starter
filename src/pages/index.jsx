        ...
        <div className="index-container">
          ...
          <main className="o-page">
            ...
            <Link to='/portfolio' className=" o-post  c-card">
              ...
              <LandingSection class="o-post__header__backdrop o-post__header__backdrop--2" max="13" size="2" id="confit-portfolio-2" animate={false} colors={[[70,184,52], [212,211,211], [43,146,28]]}></LandingSection>
            </Link>
            <Link to='/resume' className="  c-card o-post">
             <header class="o-post__header">
              ...
              <LandingSection class="o-post__header__backdrop o-post__header__backdrop--2" max="13" size="2" id="Resume-blog-2"  animate={false} colors={[[  0, 170, 255]]}></LandingSection>
            </Link>
            <Link to='/blog' className="  c-card o-post">     
             <header class="o-post__header">
              ...
              <LandingSection class="o-post__header__backdrop o-post__header__backdrop--2"  max="13" size="2" id="confit-blog-2" animate={false} colors={[[247, 211, 170], [255,119,0]]} shapes={["square", "circle"]}></LandingSection>
            </Link>
            <Link to='/experiments' className="  c-card o-post">
              ...
              <LandingSection class="o-post__header__backdrop o-post__header__backdrop--2"  max="13" size="2" id="confit-experiments-2" animate={false}  shapes={["square", "circle"]} clock="-1"></LandingSection>
            </Link>
            <Link to='/leathercraft' className="  c-card o-post">
              ...
              <LandingSection class="o-post__header__backdrop o-post__header__backdrop--2"  max="13" size="2" id="confit-leather-2" animate={false} colors={[[70,184,52], [212,211,211], [43,146,28]]} shapes={["square", "circle"]}></LandingSection>
            </Link>
